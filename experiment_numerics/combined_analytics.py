...
def plot_hermitian_data(experimental_results, numerical_results, threshold):
    ...
    plt.axvline(threshold, ls = '--', lw=2.0, color='black', label='Threshold')
...
def plot_non_hermitian_data(experimental_results, numerical_results, threshold):
    ...
    ax1.axvline(threshold, ls = '--', lw=2.0, color='black', label='Threshold')
    ...
    ax2.axvline(threshold, ls = '--', lw=2.0, color='black', label='Threshold')
