...
delta_frequency_matrix = np.abs(frequency_matrix_masked - 6.027) * 1e3
...
contour_amp_exp = ax_amp_exp.contourf(gain_values, phase_values, amplitude_matrix_reshaped, levels=500, cmap='inferno')
