...
def simulate_frequency(args):
    ...
    ## This doesn't really matter as much as the time evolution
    ...
    cutoff_frequency = 2 * kappa_c  # Define cutoff frequency as needed
    ...
    dc_fft[dc_index] = fft_result_filtered[dc_index]

    ## I need to consider both real and imag of the inverse fft to get photon numbers
...
def run_simulation_for_gain(net_gain):
    ...
    # Optional: Plotting each gain result
...
# List of gains
gains = np.linspace(-4.6, 8.4, 31)  # Example gain values from -3dB to +3dB
